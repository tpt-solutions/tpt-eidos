...
eidos-cli (`check`/`build`/`test`/`fmt`/`new`/`lsp`/`serve`). Domain libraries:
eidos-flight-math, eidos-controls-math, eidos-medical. LSP server in
eidos-lsp. Integration tests in eidos-tests over examples/.
